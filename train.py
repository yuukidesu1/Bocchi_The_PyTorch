...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "F:/PyCharm/Projects/UNet/VOCdevkit/VOC2007/ImageSets/Segmentation/train.txt"), "r") as f:      # VOC2007/ImageSets/Segmentation/train.txt
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "F:/PyCharm/Projects/UNet/VOCdevkit/VOC2007/ImageSets/Segmentation/val.txt"), "r") as f:        # VOC2007/ImageSets/Segmentation/val.txt
